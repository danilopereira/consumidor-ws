...
@XmlType(name = "Login", namespace = "http://finCliente.com.br/xsd", propOrder = {
    "senha",
    "usuario"
})
public class Login {

    @XmlElementRef(name = "senha", namespace = "http://finCliente.com.br/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> senha;
    @XmlElementRef(name = "usuario", namespace = "http://finCliente.com.br/xsd", type = JAXBElement.class, required = false)
